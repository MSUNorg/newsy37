...
class PayController extends BaseController{
    ...
    */
    public function alipay_pay(){
        ...
        $orderInfo = $orderInfo."&notify_url=\"http://{$_SERVER ['HTTP_HOST']}/callback.php/Notify/mobile_pay_notify\"";
        ...
        $orderInfo = $orderInfo."&return_url=\"http://{$_SERVER ['HTTP_HOST']}/callback.php/Notify/mobile_pay_notify\"";
        ...
        $data = array("orderInfo"=>base64_encode($orderInfo),"out_trade_no"=>$out_trade_no,"order_sign"=>$sign,"md5_sign"=>$md5_sign);
    ...
    */
    public function outher_pay(){
        ...
        if(empty($game_set_data['game_pay_appid'])){$this->set_message(0,"faill","未设置游戏支付APPID");}
        $data['status'] = 1;
        $data['return_code'] = "success";
        $data['return_msg'] = "下单成功";
        $data['token_id'] = $result_data['token_id'];
        $data['out_trade_no'] = $out_trade_no;
        $data['partner'] = C('weixin.partner');
        $data['key'] = C('weixin.key');
