...
validator={
	...
	limit : "this.checkLimit(this.strlen(value))",
...
jQuery.fn.validatorForm = function(m){
	...
	form.submit(function(){
		...
		if(typeof(m) == 'function')
		{
			...
			$.post(form.attr('action'), form.serialize(), function(json){ m(json); submit_btn.attr('disabled', false); }, 'json');
			return false;
		}
		return true;
	});
