...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
            ...
            <div class="sleft">
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('stat/userarpu','model='.$model['name'],false);?>"><i class="btn-search"></i></a>
			</div>            
		</div>
	</div>
        ...
        <div class="data-table table-striped">
            <table>
                ...
                <tbody>
                        ...
                        <td style="text-align:center"><?php echo ($game_name); ?></td>
                        <td style="text-align:center"><?php echo ($newcount); ?></td>
                        <td style="text-align:center"><?php echo ($cicount); ?></td>
                        <td style="text-align:center"><?php echo ($cilogin); ?></td>
                        <td style="text-align:center"><?php echo ($allcount); ?></td>
                        <td style="text-align:center"><?php echo ($paycount); ?></td>
                        <td style="text-align:center"><?php echo ($newpaycount); ?></td>
                        <td style="text-align:center"><?php echo ($allpay); ?></td>
                        <td style="text-align:center"><?php echo ($allrate); ?></td>
                        <td style="text-align:center"><?php echo ($userarpu); ?></td>
                        <td style="text-align:center"><?php echo ($payarpu); ?></td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('stat/userarpu');?>');
$(function(){
	//搜索功能
