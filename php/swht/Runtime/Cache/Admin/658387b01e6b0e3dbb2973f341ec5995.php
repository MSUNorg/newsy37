...
<body>
	...
	<div class="cf">
		...
		<?php if(empty($model["extend"])): ?><div class="tools">
            ...
            <button class="btn ajax-post red shiying2" target-form="ids" url="<?php echo U("Game/set_status",array("status"=>0,"msg_type"=>0,"field"=>"recommend_status"));?>">不推荐</button>
			</div><?php endif; ?>
		</div>
		<!-- 高级搜索 -->
...
<script src="/newswht/Public/static/layer/layer.js"></script>
<script type="text/javascript">
//导航高亮
