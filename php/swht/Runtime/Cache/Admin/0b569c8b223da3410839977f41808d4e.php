...
<body>
    ...
    <div>
        <button class="btn ajax-get confirm red" url="<?php echo U('clear');?>">清 空</button>
		<button class="btn ajax-post confirm red" target-form="ids" url="<?php echo U('remove');?>">删 除</button>
    </div>
	<!-- 数据列表 -->
