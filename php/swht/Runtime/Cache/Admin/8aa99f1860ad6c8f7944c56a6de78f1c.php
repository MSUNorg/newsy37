...
<body>
    ...
    <div class="cf">
        ...
        <?php if(empty($model["extend"])): ?><div class="tools">
                 <!-- <a class="btn" href="<?php echo U('Recharge/expUser',array('id'=>10,'promotename'=>I('promotename'),'GameName'=>I('GameName')));?>">导 出</a> -->
            </div><?php endif; ?>
        </div>
        <!-- 高级搜索 -->
        <div class="search-form fr cf">
            ...
            <div id="state-down" class="sleft">
                <!-- <input type="text" name="game_name" class="search-input" value="<?php echo I('game_name');?>" placeholder="请输入游戏名"> -->
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Stat/cpa_login','model='.$model['name'],false);?>">
...
$(function(){
//导航高亮
highlight_subnav('<?php echo U('stat/cpa_login');?>');
    //搜索功能
...
highlight_subnav('<?php echo U('Cpa/cpalogin');?>');
