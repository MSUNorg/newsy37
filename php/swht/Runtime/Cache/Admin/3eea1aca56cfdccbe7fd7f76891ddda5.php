...
<link rel="stylesheet" type="text/css" href="/swht/Public/Admin/css/admin_table.css" media="all">
<script type="text/javascript" src="/swht/Public/static/uploadify/jquery.uploadify.min.js"></script>
            ...
            <table  border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <tr>
                    <td class="l">游戏名称：</td>
                    <td class="r">
                        <input type="text" class="txt" value="<?php echo get_game_name($data['game_id']);?>" disabled="disabled">
                    </td>
                    <td class="l">申请人：</td>
                    <td class="r">
                        <input type="text" class="txt" value="<?php echo get_promote_name($data['promote_id']);?>" disabled="disabled">
                    </td>
                  </tr>
                  <tr>
                    <td class="l">分成比例：</td>
                    <td class="r">
                        <input type="text" class="txt" name="ratio" value="<?php echo ($data['ratio']); ?>">
                    </td>
                    <td class="l"></td>
                    <td class="r"></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <label class="inp_radio">
                            <input type="radio" class="inp_radio" value="0" name="status" <?php if(($data['status']) == "0"): ?>checked="checked"<?php endif; ?>>未审核
                            <input type="radio" class="inp_radio" value="1" name="status" <?php if(($data['status']) == "1"): ?>checked="checked"<?php endif; ?>>通过
                            <input type="radio" class="inp_radio" value="2" name="status" <?php if(($data['status']) == "2"): ?>checked="checked"<?php endif; ?>>驳回
                        </label>
                    </td>
                    <td class="l">启用状态：</td>
                    <td class="r">
                        <label class="inp_radio">
                            <input type="radio" class="inp_radio" value="0" name="enable_status" <?php if(($data['enable_status']) == "0"): ?>checked="checked"<?php endif; ?>>关闭
                            <input type="radio" class="inp_radio" value="1" name="enable_status" <?php if(($data['enable_status']) == "1"): ?>checked="checked"<?php endif; ?>>启用
                        </label>
                    </td>
                  </tr>
                </tbody>
...
Think.setValue("game_type", <?php echo ((isset($data["game_type"]) && ($data["game_type"] !== ""))?($data["game_type"]): 0); ?>);
