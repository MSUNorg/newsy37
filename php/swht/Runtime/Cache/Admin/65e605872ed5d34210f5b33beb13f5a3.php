...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn blue" href="<?php echo U('add');?>">新 增</a>
            <button class="btn ajax-post gre" url="<?php echo U('changeStatus?method=resumeUser');?>" target-form="ids">启 用</button>
            <button class="btn ajax-post red" url="<?php echo U('changeStatus?method=forbidUser');?>" target-form="ids">禁 用</button>
            <button class="btn ajax-post confirm red" url="<?php echo U('changeStatus?method=deleteUser');?>" target-form="ids">删 除</button>
        </div>
	...
	<script src="/newswht/Public/static/thinkbox/jquery.thinkbox.js"></script>
