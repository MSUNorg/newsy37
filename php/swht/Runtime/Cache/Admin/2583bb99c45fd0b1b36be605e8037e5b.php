...
<body>
	...
	<div class="main-title">
		...
		<?php if(is_array(C("CONFIG_GROUP_LIST"))): $i = 0; $__LIST__ = C("CONFIG_GROUP_LIST");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><li <?php if(($id) == $key): ?>class="current"<?php endif; ?>>
				<a href="<?php echo U('media',array(cate_id=>I('cate_id'),group_id=>$key));?>"><?php echo ($group); ?>配置</a>
			</li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
...
<script type="text/javascript">
	//导航高亮
	highlight_subnav('<?php echo U('Site/media');?>');
</script>
