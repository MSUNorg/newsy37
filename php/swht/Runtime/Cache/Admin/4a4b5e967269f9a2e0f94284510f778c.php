...
<link rel="stylesheet" type="text/css" href="/newswht/Public/Admin/css/admin_table.css" media="all">
<script type="text/javascript" src="/newswht/Public/static/uploadify/jquery.uploadify.min.js"></script>
    		...
    		<table  border="0" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="l">手机号码：</td>
                        <td class="r">
                           <input type="text" class="txt" name="mobile_phone" value="">
                        </td>
                    </tr>
                    <tr>
                        <td class="l">银行名称：</td>
                        <td class="r">
                           <input type="text" class="txt" name="bank_name" value="" >
                        </td>
                        <td class="l">银行卡号：</td>
                        <td class="r">
                           <input type="text" class="txt" name="bank_card" value="">
                        </td>
                    </tr>
                    <tr>
                       <td class="l">所属管理员：</td>
                        <td class="r">
                           <select name="admin">
                            ...
                            <?php $_result=get_admin_list();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["uid"]); ?>"><?php echo ($vo["nickname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                           </select>
                        </td>
                        <td class="l">推广员状态：</td>
                        <td class="r">
                            <label class="inp_radio">
                                <input type="radio" class="inp_radio" value="0" name="status">拉黑
                    ...
                    <tr>
                        <td class="l">电子邮件：</td>
                        <td class="r">
                           <input type="text" class="txt" name="email" value="" disabled="disabled">
                        </td>
                        <td class="l">平台币余额：</td>
                        <td class="r">
                           <input type="text" class="txt" name="balance_coin" value="" disabled="disabled">
                        </td>
                    </tr>
                </tbody>
            </table>
...
<script type="text/javascript">
Think.setValue("admin", <?php echo ((isset($UID) && ($UID !== ""))?($UID): 0); ?>);
//导航高亮
