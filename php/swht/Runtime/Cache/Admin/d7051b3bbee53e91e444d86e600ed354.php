...
<body>
    ...
    <link href="/newswht/Public/Admin/css/stat/group_figure.css" rel="stylesheet" media="all">
    <link href="/newswht/Public/Admin/css/stat/echartsHome.css" rel="stylesheet">
    <link href="/newswht/Public/Admin/css/stat/default.css" rel="stylesheet">
    <script src="/newswht/Public/Admin/js/stat/echarts.js"></script>
                            ...
                            series : [
                                {
                                    ...
                                    type:'bar',
                                    data:[
                                    "<?php echo ($year_promote[1]['amount']); ?>", 
                                    "<?php echo ($year_promote[2]['amount']); ?>", 
                                    "<?php echo ($year_promote[3]['amount']); ?>", 
                                    "<?php echo ($year_promote[4]['amount']); ?>", 
                                    "<?php echo ($year_promote[5]['amount']); ?>", 
                                    "<?php echo ($year_promote[6]['amount']); ?>", 
                                    "<?php echo ($year_promote[7]['amount']); ?>", 
                                    "<?php echo ($year_promote[8]['amount']); ?>", 
                                    "<?php echo ($year_promote[9]['amount']); ?>", 
                                    "<?php echo ($year_promote[10]['amount']); ?>", 
                                    "<?php echo ($year_promote[11]['amount']); ?>", 
                                    "<?php echo ($year_promote[12]['amount']); ?>"
                                    ],
                                    markPoint : {
                                        data : [
                                            {type : 'max', name: '最大值'},
                                ...
                                },
                                {
                                    ...
                                    type:'bar',
                                    data:[
                                    "<?php echo ($year_total[1]['amount']); ?>", 
                                    "<?php echo ($year_total[2]['amount']); ?>", 
                                    "<?php echo ($year_total[3]['amount']); ?>", 
                                    "<?php echo ($year_total[4]['amount']); ?>", 
                                    "<?php echo ($year_total[5]['amount']); ?>", 
                                    "<?php echo ($year_total[6]['amount']); ?>", 
                                    "<?php echo ($year_total[7]['amount']); ?>", 
                                    "<?php echo ($year_total[8]['amount']); ?>", 
                                    "<?php echo ($year_total[9]['amount']); ?>", 
                                    "<?php echo ($year_total[10]['amount']); ?>", 
                                    "<?php echo ($year_total[11]['amount']); ?>",
                                    "<?php echo ($year_total[12]['amount']); ?>", 
                            ...
                            series : [
                                {
                                    ...
                                    type:'bar',
                                    data:[
                                    "<?php echo ($prom_data_year[1]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[2]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[3]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[4]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[5]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[6]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[7]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[8]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[9]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[10]['counts']); ?>", 
                                    "<?php echo ($prom_data_year[11]['counts']); ?>",
                                    "<?php echo ($prom_data_year[12]['counts']); ?>", 
                                ...
                                },
                                {
                                    ...
                                    type:'bar',
                                    data:[
                                    "<?php echo ($reg_data_year[1]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[2]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[3]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[4]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[5]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[6]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[7]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[8]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[9]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[10]['counts']); ?>", 
                                    "<?php echo ($reg_data_year[11]['counts']); ?>",
                                    "<?php echo ($reg_data_year[12]['counts']); ?>", 
