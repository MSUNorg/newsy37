	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('stat/cpa_spend','model='.$model['name'],false);?>"><i class="btn-search"></i></a>
			</div>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('stat/cpa_spend');?>');
$(function(){
	//搜索功能
