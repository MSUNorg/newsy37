	...
	<div class="cf">
        ...
        <div class='sleft'>
			...
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Member/login_record','model='.$model['name'],false);?>">
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo (date('Y-m-d',$data["login_time"])); ?></td>
                            <td><a href="<?php echo U('Member/del?id='.$data['id']);?>">删除</a></td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Member/login_record');?>');
$(function(){
    //批量删除
    $("#dtnn").click(function(){
      var spCodesTemp = "";
      ...
      if(spCodesTemp==""){
        ...
        $(this).attr('href','/newswht/admin.php?s=/Member/delprovide/ids/'+spCodesTemp);
      }
