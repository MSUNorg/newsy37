...
<body>
    ...
    <div class="cf">
        ...
        <?php if(empty($model["extend"])): ?><div class="tools">
                <a class="btn settle" href="<?php echo U('settl');?>">结 算</a>
                <!-- <button class="btn" url="<?php echo U('lists');?>">结算</button> -->
            </div><?php endif; ?>
        </div>
        <!-- 高级搜索 -->
        <div class="search-form fr cf">
            ...
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Query/settlement','model='.$model['name'],false);?>"><i class="btn-search"></i></a>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["money"]); ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo get_promote_name($data['promote_id']);?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo (date('Y-m-d',$data["spend_time"])); ?></td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Query/settlement');?>');
$(function(){
    //搜索功能
